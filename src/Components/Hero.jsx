  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex-col justify-center items-center text-white">
        <div className="text-content md:w-2/4 flex flex-col items-center justify-center mt-20 md:mt-48 md:ml-48 md:p-3 absolute">
          <h1 className="font-bold text-7xl text-center px-4 z-10 md:mb-4">
