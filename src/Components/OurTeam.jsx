        ...
        <div className='flex flex-col justify-center items-center flex-grow text-white'> 
          ...
          <div className="md:flex justify-center gap-28">
            ...
            <div className='flex flex-col items-center gap-2'>
              <img src={person1} className='h-40 w-40 md:h-52 md:w-52  rounded-full border-8 border-pink-600' alt='person1' />
            ...
            {/* Person 2 */}
            <div className='flex flex-col items-center gap-2'>
              <img src={person2} className='h-40 w-40 md:h-52 md:w-52 rounded-full border-8 border-pink-600' alt='person2' />
